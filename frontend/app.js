    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        reviewForm.addEventListener("submit", function (event) {
            ...
            review.innerHTML = `
                ...
                <p>${reviewText}</p>
                <button class="delete-review">Remove</button>
            `;
            ...
            review.querySelector(".delete-review").addEventListener("click", function () {
                review.remove();
            });
        ...
        document.getElementById("add-review-button").addEventListener("click", function() {
            ...
            window.location.href = `add-reviews.html?userId=${userId}`;
        });
